...
export default function HeroSection() {
  return (
    <div className="h-screen md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0 bg-grid-white/5 bg-black">
